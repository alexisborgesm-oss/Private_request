  ...
  return (
    <div className="mx-auto max-w-2xl">
      <div className="flex items-start justify-between gap-3">
        <div>
          <div className="text-2xl font-semibold">{r.cls?.name ?? "Private request"}</div>
      ...
      <Card className="mt-6 space-y-2">
        ...
        <div className="text-sm text-ink/70">Base price: <span className="font-medium">${r.cls?.base_price}</span> • Duration: <span className="font-medium">{r.cls?.duration_minutes} min</span></div>
